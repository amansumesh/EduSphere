    ...
    <div className="pb-14 px-8 md:px-0">
      ...
      <div className="grid grid-cols-auto gap-8 mt-14">
        {dummyTestimonial.map((testimonial, index) => (
          <div
            key={index}
            className="text-sm text-left  border border-white/10 pb-6 rounded-lg bg-white/5 shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden"
          >
            ...
            <a href="#" className="text-brand-purple-400 underline px-5">
              Read more
            </a>
          </div>
        ))}
